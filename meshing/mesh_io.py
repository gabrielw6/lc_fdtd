...
class MeshResult:
    ...
    cavity_volume: float  # from OCC mass properties, independent of Module 1/3 (Section 2.3)
    sample_volume: float  # from OCC mass properties, independent of Module 1/3 (Section 2.3)
