...
from meshing.geometry_spec import Box, Sphere
from meshing.interference import SampleExceedsCavityError, check_containment
...
def _cavity_and_sample(sample_center):
    cav_dim_tag = standard_shapes.build_cavity_solid(Box(A, B, C))
...
def test_default_tolerance_scales_with_sample_size():
    ...
    from meshing.interference import _TOLERANCE_FACTOR
